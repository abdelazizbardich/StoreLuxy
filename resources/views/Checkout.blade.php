                    ...
                    <div class="row align-items-stretch" style="min-height: calc(105vh);">
                        ...
                        <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6" style="background-color: #FFE600;position: relative;padding-right: 0;">
                            <div style="margin-top: 12vh;margin-left: 15%;margin-bottom: 12vh;position: relative;animation: 1;">
                                ...
                                <div style="margin-right: 15%;"><span style="font-size: 18px;line-height: 28px;">@lang("Frais de Taxes"):</span><span style="font-size: 18px;line-height: 28px;float: right;font-weight: bold;"><span class="tax">{{$totalTax}}</span> @lang("Dh")</span></div>
                                <div style="margin-right: 15%;"><span style="font-size: 18px;line-height: 28px;">@lang("Total du Commande"):</span><span style="font-size: 18px;line-height: 28px;float: right;font-weight: bold;color: rgb(255,0,0);"><span class="total-order"></span> @lang("Dh")</span></div>
