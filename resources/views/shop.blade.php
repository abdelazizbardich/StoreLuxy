@include('inc.header')
    <main style="min-height: 100vh;position: relative;overflow: hidden;padding-bottom: 80px;">
        <div style="height: 150px;background-color: #F7F8FA;position: relative;">
            <p class="text-center" style="font-size: 54px;line-height: 74px;font-weight: bold;position: absolute;left: 0;right: 0;top: 0;bottom: 0;margin: auto;height: fit-content;width: fit-content;"><strong>BOUTIQUE</strong></p>
        </div>
        ...
        <div style="margin-bottom: 35px;">
            <div class="container">
                <div class="row">
                    <div class="col-12 col-sm-12 col-md-3 col-lg-3 col-xl-3"><span style="font-size: 18px;line-height: 24px;font-weight: bold;display: block;padding-bottom: 15px;border-bottom: 1px solid rgb(255,230,0);">Catalogue:</span>
                        ...
                        <div><span style="font-size: 14px;line-height: 19px;display: block;">Prix:</span><input type="range" class="priceRange" style="width: 100%;">
                    ...
                    <div class="col-12 col-sm-12 col-md-9 col-lg-9 col-xl-9"><span style="font-size: 18px;line-height: 24px;font-weight: bold;display: block;/*border-bottom: 1px solid rgb(255,230,0);*/padding-bottom: 15px;"><strong>Produits populaires:</strong></span>
                        <div>
                            <div class="container">
