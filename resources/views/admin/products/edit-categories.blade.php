                        ...
                        <div>
                            <div class="row no-gutters" style="padding: 5px;">
                                <div class="col" style="padding: 15px;">
                                    ...
                                    <form action="/admin/produit/categories/modifier" method="POST" enctype="multipart/form-data">
                                    <input type="text" name="id" value="{{$thisCategory->id}}" hidden />
                                        @csrf
                                        @method('POST')
                                        <div class="form-group">
                                            <label style="line-height: 22px;font-size: 16px;">Nom:</label>
                                            <input class="form-control" value="{{$thisCategory->name}}" type="text" name="title">
                                        </div>
                                        <div class="form-group">
                                            <label style="line-height: 22px;font-size: 16px;">Nom de la limace:</label>
                                            <input class="form-control" value="{{$thisCategory->slug_name}}" type="text" name="sub_title"></div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea name="description" class="form-control" style="min-height: 150px;">{{$thisCategory->car_desc}}</textarea>
                                        </div>
                                        <div class="form-group">
                                            <div class="form-check">
                                            <?php if($thisCategory->in_home == '1'){$state = 'checked';}else{$state='';} ?>
                                                <input name="in_home" {{$state}} class="form-check-input" type="checkbox" id="formCheck-1">
                                                <label class="form-check-label {{$state}}" for="formCheck-1" style="margin-left: 15px;">Afficher dans la page d'accueil</label>
                                            </div>
                                        </div>
