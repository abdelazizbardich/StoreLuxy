                ...
                <div class="row justify-content-center align-items-center" style="height: 100%;">
                    <div class="col-9">
                        <form action="/suivi-de-commande" method="POST">
                            ...
                            <div class="form-row">
                                <div class="col">
                                    <div class="form-group text-center">
                                        <h1 style="font-size: 45px;line-height: 61px;font-weight: bold;">@lang("Suivez votre commande")</h1>
                                            @if(count($errors) > 0)
                            ...
                            <div class="form-row">
                                <div class="col">
                                    <div class="form-group{{ $errors->has('code') ? ' has-error' : '' }}"><label for="code" style="font-size: 18px;line-height: 24px;font-weight: bold;">@lang("Code du commande"):</label>
                                    <input id="code" value="{{ Request::old('code') }}" name="code" class="form-control" type="text" style="border: 1px solid #FFCB00;border-radius: 0px;background-color: #F7F8FA;font-size: 14px;line-height: 19px;height: 50px;"
                                            placeholder="@lang("Tapez le code de votre commande ici")...">
                                            @error('code')
                    ...
                    @elseif(isset($orderDetails->details))
                        <div class="col-9">
                                <div class="order-details">
                                    <div>
                                        <p style="background: #ffd50026;padding: 5px 15px;border-radius: 10px;width: fit-content;"><span style="font-weight: bold;">@lang("Date"):</span>&nbsp;{{$orderDetails->details->created_at}}<br></p>
                                        <p style="background: #ffd50026;padding: 5px 15px;border-radius: 10px;width: fit-content;"><span style="font-weight: bold;">@lang("Code"):</span>&nbsp;{{$orderDetails->details->code}}<br></p>
                                        <p style="background: #ffd50026;padding: 5px 15px;border-radius: 10px;width: fit-content;"><span style="font-weight: bold;">@lang("Nom du client"):</span>&nbsp;{{$orderDetails->details->first_name}}&nbsp;{{$orderDetails->details->last_name}}<br></p>
                                        ...
                                        <p style="background: #ffd50026;padding: 5px 15px;border-radius: 10px;width: fit-content;"><span style="font-weight: bold;">@lang("Produits"):</span></p>
                                                ...
                                                <div class="col-12 col-lg-6 col-xl-6 text-left fixed-carte-product" style="padding: 10px;margin-bottom: 15px;">
                                                        <table>
                                                            <tr>
                                                                ...
                                                                <p style="width: 100%;font-size: 14px;line-height: 19px;margin: 0; color: #ff0000;"><strong>@lang("Prix total"): {{$product->total_price}}@lang("Dh")</strong><br></p>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </div>
                                        ...
                                        <p style="background: #ffd50026;padding: 5px 15px;border-radius: 10px;width: fit-content;"><span style="font-weight: bold;">@lang("Total du panier"):</span>&nbsp;{{$orderDetails->details->total_cart}} @lang("Dh")</p>
                                        <p style="background: #ffd50026;padding: 5px 15px;border-radius: 10px;width: fit-content;"><span style="font-weight: bold;">@lang("Frais de livraison"):</span>&nbsp;{{$orderDetails->details->shipping_cost}} @lang("Dh")</p>
                                        <p style="background: #ffd50026;padding: 5px 15px;border-radius: 10px;width: fit-content;"><span style="font-weight: bold;">@lang("Frais de tax"):</span>&nbsp;{{$orderDetails->details->tax_cost}} @lang("Dh")</p>
                                        <p style="background: #ffd500;padding: 5px 15px;border-radius: 5px;width: fit-content;border: 2px solid #ffae00;"><span style="font-weight: bold;">@lang("Total du commande"):</span>&nbsp;{{$orderDetails->details->total_order}} @lang("Dh")</p>
                                        <p style="background: #ffd50026;padding: 5px 15px;border-radius: 10px;width: fit-content;"><span style="font-weight: bold;">@lang("Remarque"):</span>&nbsp;{{$orderDetails->details->note}}</p>
                                    </div>
                            </div>
                        </div>
                    @endif
