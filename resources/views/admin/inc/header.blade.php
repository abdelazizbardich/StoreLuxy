...
<head>
    ...
    <link href="/assets/admin/css/datetimepicker/bootstrap-datetimepicker.min.css" rel="stylesheet" media="screen">
</head>
        ...
        <div class="container-fluid">
            <div class="row justify-content-between">
                <div class="col-10 col-sm-7 col-md-5 col-lg-3 col-xl-2 d-none d-sm-none d-md-none d-lg-block d-xl-block" id="side-menu">
                    <div style="left: 0;right: 0;top: 0;padding: 0px 15px;">
                        <div class="text-center" style="margin: 10px 0px;padding: 5px;"><a href="{{ $options->SiteOptions->site_url}}/admin" style="display: block;text-align: center;"><img class="img-fluid" src="{{ asset('storage/' . $options->SiteOptions->site_logo)}}"></a><button class="btn btn-primary close" type="button" style="position: absolute;top: 15px;right: 5px;color: var(--color-orenge);background: none;border: none;box-shadow: none;opacity: 1;text-shadow: none;"><i class="fa fa-close d-lg-none d-xl-none"></i></button></div>
                        <hr class="white-horizental-line-02">
                            <div style="margin: 10px 0px;padding: 5px;">
                                <div class="text-center"></div><a href="#" style="display: block;text-align: center;"><img class="user-avatar" src="{{ asset( 'storage/' .Session::get('userData')->avatar->file)}}"></a></div>
                            <div class="text-center" style="margin: 10px 0px;padding: 5px;"><a href="#" style="text-decoration: none;"><span style="color: var(--color-white);font-size: 20px;line-height: 27px;">{{Session::get('userData')->first_name}} {{Session::get('userData')->last_name}}</span></a></div>
                            <hr class="white-horizental-line-02">
