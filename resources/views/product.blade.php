...
<main style="min-height: 100vh;position: relative;overflow: hidden;padding-bottom: 80px;">
    ...
    <div id="product-banner"
        style="min-height: calc(100vh - 210px);margin-bottom: 35px;padding-top: 15px;padding-bottom: 15px;">
        <div class="container">
            <p><a href="/">@lang('accueil')&nbsp;</a>&nbsp;&gt;&nbsp;<a
                    href="/boutique">@lang('Boutique')&nbsp;</a>&nbsp;&gt;&nbsp;
            ...
            <div class="row">
                <div class="col-12 col-sm-12 col-md-6 col-lg-6" style="margin-bottom: 15px;"><img
                        class="img-fluid lightZoom" title="{{ $Thumbnail->name }}" alt="{{ $Thumbnail->alt_title }}"
                        src="{{ asset('storage/' . $Thumbnail->file) }}" style="margin-bottom: 5px; width:100%">
                    <div>
                        <div class="row no-gutters">
                            @foreach ($Photos as $Photo)
                                <div class="col-2"><img style="padding: 2px;" class="img-fluid lightZoom"
                                        title="{{ $Photo->name }}" alt="{{ $Photo->alt_title }}"
                                        src="{{ asset('storage/' . $Photo->file) }}"></div>
                            @endforeach
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-lg-6 col-xl-6">
                    ...
                    <div><span class="price">{{ $Product->price }}@lang('Dh')</span><span
                            class="old-price"><span
                                style="text-decoration: line-through;">{{ $Product->old_price }}@lang('Dh')</span></span><span
                            dir="ltr" class="reduction"><?php echo '-' . number_format(100 - ($Product->price / $Product->old_price) * 100, 2, '.', '') . '%'; ?></span></div>
                    ...
                    <div id="dealcount">
                        ...
                        <div class="progress" style="height: 33px;border-radius: 17px;">
                            ...
                            <div class="progress-bar"
                                ...
                                style="width: {{ number_format(($Product->stock_amount / $Product->stock_size) * 100, 2, '.', '') }}%;">
                                <span
                                    class="sr-only">{{ number_format(($Product->stock_amount / $Product->stock_size) * 100, 2, '.', '') }}%</span>
                            </div>
                        ...
                        <div id="countDown" class="countdown-circles d-flex flex-wrap justify-content-center pt-4"><span
                            ...
                            <ul class="list-inline" id="countdown">
                                <li class="list-inline-item text-center"><span id="days"
                                        style="display: block;background-color: #ff0000;color: rgb(255,255,255);font-size: 36px;line-height: 61px;width: 60px;height: 60px;">-</span><span>@lang('Journées')</span>
                                </li>
                                <li class="list-inline-item text-center"><span id="hours"
                                        style="display: block;background-color: #ff0000;color: rgb(255,255,255);font-size: 36px;line-height: 61px;width: 60px;height: 60px;">-</span><span>@lang('Heures')</span>
                                </li>
                                <li class="list-inline-item text-center"><span id="minutes"
                                        style="display: block;background-color: #ff0000;color: rgb(255,255,255);font-size: 36px;line-height: 61px;width: 60px;height: 60px;">-</span><span>@lang('Minutes')</span>
                                </li>
                                <li class="list-inline-item text-center"><span id="seconds"
                ...
                <div class="col-12 col-sm-12 col-md-12 col-lg-9 col-xl-9" style="margin-bottom: 15px;">
                    ...
                    <div id="product-details"
                        ...
                        <div class="product-details-content">
                            {!! $Product->long_desc !!}
                        </div><button class="btn btn-primary shadow" id="show-more-details" type="button"
                            style="width: 54px;height: 54px;border-radius: 50%;position: absolute;bottom: -27px;left: 0;right: 0;margin: auto;background-color: rgb(255,255,255);border: none;z-index: 1;"><i
                                class="fa fa-chevron-down" style="color: rgb(255,230,0);"></i></button>
                        <div class="feader"
                            style="width: 100%;height: 150px;background-image: linear-gradient(rgba(0,0,0,0), rgba(255,223,0,0.3));position: absolute;bottom: 0;left: 0;right: 0;">
                        </div>
                    </div>
                    <div style="background-color: #F7F8FA;padding-left: 15px;padding-right: 15px;margin-bottom: 35px;">
                    ...
                    <div>
                        <div class="row no-gutters align-items-center">
                            <div class="col-sm-12 col-md-4 col-lg-6 text-center text-sm-center text-md-left text-lg-left text-xl-left"
                                ...
                                <p style="font-size: 82px;line-height: 61px;font-weight: bold;">
                                    {{ $globalStarsAvr }}/5</p><span><img src="/assets/img/Icon%20ionic-ios-star.svg"
                                        style="margin-right: 3px;width: 16px;"><img
                                        src="/assets/img/Icon%20ionic-ios-star.svg"
                                        style="margin-right: 3px;width: 16px;"><img
                                        src="/assets/img/Icon%20ionic-ios-star.svg"
                                        style="margin-right: 3px;width: 16px;"><img
                                        src="/assets/img/Icon%20ionic-ios-star.svg"
                                        style="margin-right: 3px;width: 16px;"><img
                                        src="/assets/img/Icon%20ionic-ios-star-outline.svg"
                                        style="margin-right: 3px;width: 16px;"></span><span>&nbsp;{{ $reviewsCount }}
                                    @lang('évaluations')</span>
                            </div>
                            <div class="col" style="margin-bottom: 15px;">
                                <div class="row no-gutters align-items-center" style="margin-bottom: 10px;">
                                    <div class="col-auto" style="line-height: 0;"><span><img
                                                src="/assets/img/Icon%20ionic-ios-star.svg"
                                                style="margin-right: 3px;width: 15px;"><img
                                                src="/assets/img/Icon%20ionic-ios-star.svg"
                                                style="margin-right: 3px;width: 15px;"><img
                                                src="/assets/img/Icon%20ionic-ios-star.svg"
                                                style="margin-right: 3px;width: 15px;"><img
                                                ...
                                                style="margin-right: 3px;width: 15px;"><img
                                                src="/assets/img/Icon%20ionic-ios-star.svg"
                                                style="margin-right: 3px;width: 15px;"></span></div>
                                    <div class="col">
                                        <div class="progress" style="border-radius: 0px;margin-right: 15px;">
                                            <div class="progress-bar" aria-valuenow="100" aria-valuemin="0"
                                                aria-valuemax="100"
                                                style="width: {{ $reviewStarsCountArr->star5 }}%;"><span
                                                    class="sr-only">{{ $reviewStarsCountArr->star5 }}%</span></div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row no-gutters align-items-center" style="margin-bottom: 10px;">
                                    ...
                                    <div class="col">
                                        <div class="progress" style="border-radius: 0px;margin-right: 15px;">
                                            <div class="progress-bar"
                                                aria-valuenow="{{ $reviewStarsCountArr->star4 }}" aria-valuemin="0"
                                                aria-valuemax="100"
                                                style="width: {{ $reviewStarsCountArr->star4 }}%;"><span
                                                    class="sr-only">{{ $reviewStarsCountArr->star4 }}%</span></div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row no-gutters align-items-center" style="margin-bottom: 10px;">
                                    ...
                                    <div class="col">
                                        <div class="progress" style="border-radius: 0px;margin-right: 15px;">
                                            <div class="progress-bar"
                                                aria-valuenow="{{ $reviewStarsCountArr->star3 }}" aria-valuemin="0"
                                                aria-valuemax="100"
                                                style="width: {{ $reviewStarsCountArr->star3 }}%;"><span
                                                    class="sr-only">{{ $reviewStarsCountArr->star3 }}%</span></div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row no-gutters align-items-center" style="margin-bottom: 10px;">
                                    ...
                                    <div class="col">
                                        <div class="progress" style="border-radius: 0px;margin-right: 15px;">
                                            <div class="progress-bar"
                                                aria-valuenow="{{ $reviewStarsCountArr->star2 }}" aria-valuemin="0"
                                                aria-valuemax="100"
                                                style="width: {{ $reviewStarsCountArr->star2 }}%;"><span
                                                    class="sr-only">{{ $reviewStarsCountArr->star2 }}%</span></div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row no-gutters align-items-center" style="margin-bottom: 10px;">
                                    ...
                                    <div class="col">
                                        <div class="progress" style="border-radius: 0px;margin-right: 15px;">
                                            <div class="progress-bar"
                                                aria-valuenow="{{ $reviewStarsCountArr->star1 }}" aria-valuemin="0"
                                                aria-valuemax="100"
                                                style="width: {{ $reviewStarsCountArr->star1 }}%;"><span
                                                    class="sr-only">{{ $reviewStarsCountArr->star1 }}%</span></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    @foreach ($reviews as $review)
                        <div class="review">
                            ...
                            <p>@lang('Par')&nbsp;<span
                                    style="color: rgb(0,102,255);">{{ $review->data->username }}</span></p>
                                    ...
                                    @if (isset($review->photos))
                                        @foreach ($review->photos as $photo)
                                            <li class="list-inline-item"><img
                                                    class="img-thumbnail img-fluid lightZoom"
                                                    src="{{ asset('storage/' . $photo->file) }}"></li>
                                        @endforeach
                                    @endif
                                </ul>
                            </div>
                    ...
                    <div style="background-color: #ffffff;border: 2px solid #ffe600;">
                        <div style="background-color: #ffe600;padding: 15px;"><span
                                style="font-size: 21px;line-height: 28px;font-weight: bold;">@lang('Écrivez Une Avis')</span>
                        </div>
                        <form style="padding: 15px;" method="POST" action="/produit/nouvelle-avis"
                                ...
                                <div class="col">
                                    ...
                                    <div class="form-group{{ $errors->has('fulnamelname') ? ' has-error' : '' }}">
                                        ...
                                        <input class="form-control" name="name"
                                            ...
                                            placeholder="@lang('Tapez votre nom')..."
                                    ...
                                    <div class="form-group{{ $errors->has('strCount') ? ' has-error' : '' }}">
                                        ...
                                        <ul class="list-inline starsList">
                                            <li class="list-inline-item str" data-order="1"><span
                                                    style="position: relative;"><input type="checkbox"
                                                        style="width: 100%;height: 100%;position: absolute;top: 0;right: 0;left: 0;bottom: 0;opacity: 0;z-index: 1;"><img
                                                        src="/assets/img/Icon%20ionic-ios-star.svg"
                                                        style="margin-right: 3px;width: 22px;opacity: 0.50;"></span>
                                            </li>
                                            <li class="list-inline-item str" data-order="2"><span
                                                    style="position: relative;"><input type="checkbox"
                                                        style="width: 100%;height: 100%;position: absolute;top: 0;right: 0;left: 0;bottom: 0;opacity: 0;z-index: 1;"><img
                                                        src="/assets/img/Icon%20ionic-ios-star.svg"
                                                        style="margin-right: 3px;width: 22px;opacity: 0.50;"></span>
                                            </li>
                                            <li class="list-inline-item str" data-order="3"><span
                                                    style="position: relative;"><input type="checkbox"
                                                        style="width: 100%;height: 100%;position: absolute;top: 0;right: 0;left: 0;bottom: 0;opacity: 0;z-index: 1;"><img
                                                        src="/assets/img/Icon%20ionic-ios-star.svg"
                                                        style="margin-right: 3px;width: 22px;opacity: 0.50;"></span>
                                            </li>
                                            <li class="list-inline-item str" data-order="4"><span
                                                    style="position: relative;"><input type="checkbox"
                                                        style="width: 100%;height: 100%;position: absolute;top: 0;right: 0;left: 0;bottom: 0;opacity: 0;z-index: 1;"><img
                                                        src="/assets/img/Icon%20ionic-ios-star.svg"
                                                        style="margin-right: 3px;width: 22px;opacity: 0.50;"></span>
                                            </li>
                                            <li class="list-inline-item str" data-order="5"><span
                                                    style="position: relative;"><input type="checkbox"
                                                        style="width: 100%;height: 100%;position: absolute;top: 0;right: 0;left: 0;bottom: 0;opacity: 0;z-index: 1;"><img
                                                        src="/assets/img/Icon%20ionic-ios-star.svg"
                                                        style="margin-right: 3px;width: 22px;opacity: 0.50;"></span>
                                        ...
                                        <input class="form-control" type="text" id="strCount" required=""
                                            value="{{ count($errors) > 0 ? Request::old('strCount') : '5' }}"
                                ...
                                <a href="/produit/{{ $SProduct->Product->slug_name }}">
                                    <div class="col-12 col-sm-6 col-md-3 col-lg-12 text-center"
                                        ...
                                        <div class="text-center"
                                            ...
                                            <img style="margin-bottom: 10px;" class="img-fluid"
                                                alt="{{ $SProduct->Thumbnail->alt_title }}"
                                                title="{{ $SProduct->Thumbnail->name }}"
                                                description="{{ $SProduct->Thumbnail->file_desc }}"
                                                src="{{ asset('storage/' . $SProduct->Thumbnail->file) }}">
    ...
    <div style="margin-bottom: 75px;margin-top: 60px;">
        ...
        <div class="container">
            @if ($similarProducts)
                <p style="font-size: 24px;line-height: 32px;font-weight: bold;margin: 0;">
                    &nbsp;<strong>@lang('De la même catégorie'):</strong></p>
            @endif
    ...
    </div><img src="/assets/img/Intersection%205-1.svg"
        style="position: absolute;left: 0;top: 125vh;z-index: -1;width: 50%;">
</main>
@include('inc.footer')
