                    ...
                    <div style="left: 0;right: 0;top: 0;padding: 0px 15px;">
                        ...
                        <hr class="white-horizental-line-02">
                            <div style="margin: 10px 0px;padding: 5px;">
                                <div class="text-center"></div><a href="#" style="display: block;text-align: center;"><img class="user-avatar" src="{{ asset( 'storage/' .((Session::get('userData'))?Session::get('userData')->avatar->file:""))}}"></a></div>
