                    ...
                    @foreach($TrendingProducts as $TrendingProduct)
                        <div class="col-12 col-sm-5 col-md-4 col-lg-3 col-xl-3" style="margin-bottom: 15px;">
                            ...
                            <a href="/produit/{{$TrendingProduct->product->slug_name}}">
                                ...
                                <a class="btn btn-primary text-uppercase btn-add-to-carte w-100 p-2" data-id="{{$TrendingProduct->product->id}}" role="button" style="margin: auto;border: none;border-radius: 0;font-size: 12px;color: rgb(255,255,255);"><i class="fa fa-cart-plus"></i>&nbsp;@lang("Ajouter au panier")</a>
                            </div>
                        </div>
                    @endforeach
                </div>
                    ...
                    @foreach($BestSallerProducts as $BestSallerProduct)
                            <div class="col-12 col-sm-5 col-md-4 col-lg-3 col-xl-3" style="margin-bottom: 15px;">
                                <div class="text-center" style="padding: 8px;background: white;border: 1px solid #dbb300;height: 100%;">
                                    ...
                                    <a class="btn btn-primary text-uppercase btn-add-to-carte w-100 p-2" data-id="{{$BestSallerProduct->product->id}}" role="button" style="margin: auto;border: none;border-radius: 0;font-size: 12px;color: rgb(255,255,255);"><i class="fa fa-cart-plus"></i>&nbsp;@lang("Ajouter au panier")</a>
                                </div>
                            </div>
                        @endforeach
                </div>
