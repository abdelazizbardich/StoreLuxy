                        ...
                        <div>
                            <div class="row no-gutters" style="padding: 5px;">
                                <div class="col" style="padding: 15px;">
                                    <p style="font-size: 20px;line-height: 27px;font-weight: bold;">Modifier la catégorie:</p>
                                    <form action="/admin/articles/categories/modifier" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        @method('POST')
                                        <input type="text" name="id" value="{{$thisCategory->id}}" hidden>
                                        <div class="form-group"><label style="line-height: 22px;font-size: 16px;">Nom:</label>
                                        <input class="form-control" type="text" name="title" value="{{$thisCategory->name}}"></div>
                                        <div class="form-group"><label style="line-height: 22px;font-size: 16px;">Nom de la limace:</label>
                                        <input class="form-control" type="text" name="sub_title" value="{{$thisCategory->slug_name}}"></div>
                                        <div class="form-group">
                                            <label style="line-height: 22px;font-size: 16px;">La description:</label>
                                            <textarea class="form-control" style="min-height: 150px;" name="description">{{$thisCategory->car_desc}}</textarea></div>
                                        ...
                                        <input type="text" value="{{$thisCategory->thumbnail->id}}" hidden class="form-control" name="thumbnail"><img class="img-fluid thumbnail-placeholder" src="{{ asset('storage/' . $thisCategory->thumbnail->file)}}"></div></div>
                                        
                                        <div class="form-group"><button class="btn btn-primary btn-block btn-lg" type="submit">Modifier la catégorie</button></div>
                                    </form>
                                </div>
